...
export const PlayerSignUp = ({ onClose, onSwitchToPlayerSignIn }) => {
  ...
  const handleResendCode = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/verification/resend-verification`,
        {
          method: "POST",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/verification/player-signup`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  const handleVerifyCode = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/verification/verify-email`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
